/* global React, Icons, TemplatesPage */
const { useState } = React;

function CreateSiteModal({ open, onClose, onCreate }) {
  ...
  const submit = () => {
    setCreating(true);
    setTimeout(() => { setCreating(false); onCreate({ name: name || "Untitled site", slug: slug || "untitled", template: tmpl }); }, 700);
  };
...
window.CreateSiteModal = CreateSiteModal;
