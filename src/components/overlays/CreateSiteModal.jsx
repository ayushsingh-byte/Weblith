          ...
          {step === 2 && (
            <div className="fade-in" style={{ paddingTop: 8 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <span className="mono" style={{ padding: '10px 12px', background: 'var(--bg-sunk)', border: '1px solid var(--line)', borderRight: 'none', borderRadius: '10px 0 0 10px', color: 'var(--ink-3)', fontSize: 12, whiteSpace: 'nowrap' }}>forge.site /</span>
